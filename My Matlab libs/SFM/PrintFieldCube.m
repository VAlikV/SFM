function PrintFieldCube(lx, ly, lz, nx, ny, nz, centerFOV, Bdes, level, plane, Lx, Ly, Lz, centerROI, Title, name, type) % Отрисовка поля
